<div class="surface-card mb-4">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-3"><div class="stat-card"><span>Invoice</span><strong><?= htmlspecialchars((string) ($row['invoice_number'] ?? '-')) ?></strong><small><?= htmlspecialchars($row['nama_paket']) ?></small></div></div>
    </div>
</div>
