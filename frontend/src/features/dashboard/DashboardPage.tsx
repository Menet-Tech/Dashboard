      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {pageLoading ? (
          ...
          summaryCards.map((card) => (
            ...
            >
              <span className="text-xs font-bold text-slate-400 dark:text-slate-500 dark:text-slate-500 uppercase tracking-wider mb-2">{card.label}</span>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <article className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-card p-5 shadow hover:shadow-md transition-shadow flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <h2 className="text-base font-bold text-slate-800 dark:text-slate-100 mb-2">Operasional Hari Ini</h2>
        ...
        <article className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-card p-5 shadow hover:shadow-md transition-shadow flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <h2 className="text-base font-bold text-slate-800 dark:text-slate-100 mb-2">Run Berikutnya</h2>
        ...
        <article className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-card p-5 shadow-sm">
          ...
          <div className="overflow-x-auto border border-gray-200 dark:border-slate-800 rounded-card bg-white dark:bg-slate-900 shadow-sm">
            <table className="w-full text-left border-collapse text-sm min-w-[600px]">
              <thead className="bg-gray-50 dark:bg-slate-800 dark:bg-slate-950 border-b border-gray-250 dark:border-slate-800 text-slate-500 dark:text-slate-400 text-xs font-bold uppercase">
                <tr>
                  ...
                  summary.pembayaran_terbaru.map((p) => (
                    <tr key={p.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/40 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className="uppercase tracking-wider text-[9px] font-extrabold bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 dark:text-slate-300 px-2 py-1 rounded-lg border border-slate-200 dark:border-slate-800 dark:border-slate-700">
                          {p.payment_method}
                        </span>
                      </td>
                    </tr>
