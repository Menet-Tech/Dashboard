    ...
    >
      <div className="space-y-4 min-h-[300px] max-h-[500px] flex flex-col">
        ...
        {loading ? (
          ...
          <div className="flex-1 overflow-y-auto border border-slate-100 dark:border-slate-800/80 rounded-card bg-white dark:bg-slate-900 divide-y divide-slate-100 dark:divide-slate-800">
