...
export function NetworkMapPage({ pushSuccess, pushError }: NetworkMapPageProps) {
  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-4 gap-6 animate-in">
      {/* Sidebar Editor */}
      <div className="lg:col-span-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-card p-5 shadow-sm flex flex-col justify-between min-h-[500px]">
        <div>
          ...
          {selectedEdgeForWaypoints && (() => {
            ...
            if (!edge) return null;
            return (
              <div className="mt-4 border border-indigo-150 rounded-card p-4 bg-indigo-50/30 space-y-3 font-sans">
      ...
      <div className="lg:col-span-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-card overflow-hidden shadow-sm min-h-[550px] relative">
        {activeTool !== "select" && (
      ...
      {isNodeModalOpen && (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
          <form
            ...
            className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-card p-6 shadow-xl w-full max-w-md animate-in"
          >
      ...
      {confirmModal && (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[10000] flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-card p-6 shadow-xl w-full max-w-sm animate-in">
            <div className="flex items-center justify-between border-b pb-3 mb-4">
              <h3 className="text-base font-bold text-slate-900 dark:text-slate-50 flex items-center gap-2">
