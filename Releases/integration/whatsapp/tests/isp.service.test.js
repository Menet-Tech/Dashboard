...
describe('ISP service adapter', () => {
    ...
    it('findCustomerByPhone mengembalikan pelanggan pertama', async () => {
        ...
        await expect(service.findCustomerByPhone('08123@c.us')).resolves.toEqual({ id: 7, nama: 'Budi' });
    ...
    it('notifyAdminViaWA mengirim ke semua admin yang dikonfigurasi', async () => {
        ...
        await service.notifyAdminViaWA({ phone: '628999@c.us', contactName: 'Ani', accountId: 'support' }, sendFn);
